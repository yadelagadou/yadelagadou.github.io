// player doit être global (utilisé aussi par searchVideos)
let player = null;
...
function playVideoById(videoId) {
  ...
  // Si le player est prêt, on joue immédiatement
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function loadYouTubeAPI() {
    if (window.__YT_API_LOADING__) return;
  ...
  function onPlayerReady(event) {
    ...
    // si un clic a eu lieu avant que le player soit prêt, on joue la demande
    if (pendingVideoId) {
